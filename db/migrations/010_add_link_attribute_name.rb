Sequel.migration do
  up do
    ...
    Magma.instance.db.execute("INSERT into attributes SET (project_name, model_name, attribute_name, link_model_name, type, column_name, link_attribute_name) VALUES ('ipi', 'patient', 'panel_patients', 'patient', 'collection', 'panel_patients', 'reference_patient')")
