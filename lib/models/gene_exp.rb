...
class GeneExp < Magma::Model
  ...
  attribute :ensembl_name, index: true, type: String, desc: "Ensembl gene ID"
  attribute :hugo_name, index: true, type: String, desc: "HGNC gene symbol" # this could be blank
